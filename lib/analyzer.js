...
class Analyzer {
  ...
  _metaTitlesReport() {
    ...
    const missing = pages200.filter(p => !p.title);
    const tooShort = pages200.filter(p => p.title && p.titleLength < 30);
    const tooLong = pages200.filter(p => p.title && p.titleLength > 60);
    const optimal = pages200.filter(p => p.title && p.titleLength >= 30 && p.titleLength <= 60);
  ...
  _metaDescriptionsReport() {
    const pages200 = this.pages200;
    const missing = pages200.filter(p => !p.metaDescription);
    const tooShort = pages200.filter(p => p.metaDescription && p.metaDescriptionLength < 70);
    const tooLong = pages200.filter(p => p.metaDescription && p.metaDescriptionLength > 160);
    const optimal = pages200.filter(p => p.metaDescription && p.metaDescriptionLength >= 70 && p.metaDescriptionLength <= 160);
